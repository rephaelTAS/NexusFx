...
import com.ossobo.nexusfx.userhelp.*;
...
// ================================================================
    ...
    public static void diagnoseQuick() {
        ...
        if (bootstrapOk && bootstrap.getResourceAPI() != null) {
            ...
            System.out.println("   ├─ Views FXML: " + api.countByType(com.ossobo.nexusfx.resources.enums.ResourceType.FXML));
            System.out.println("   ├─ Imagens: " + api.countByType(com.ossobo.nexusfx.resources.enums.ResourceType.IMAGE));
            System.out.println("   ├─ CSS: " + api.countByType(com.ossobo.nexusfx.resources.enums.ResourceType.CSS));
            System.out.println("   ├─ Sons: " + api.countByType(com.ossobo.nexusfx.resources.enums.ResourceType.SOUND));
            System.out.println("   └─ Alertas: " + api.countByType(com.ossobo.nexusfx.resources.enums.ResourceType.ALERT));
        }
